...
class UnitScaleTest {
    ...
    @Test
    fun construction_withPredefinedMagnitude_autoUsesPredefinedPrefix() =
            assertEquals("k", UnitScale(1000).prefix)

    @Test
    fun construction_withPredefinedMagnitudeDouble_autoUsesPredefinedPrefix() =
